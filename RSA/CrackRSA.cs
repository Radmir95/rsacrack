    ...
    public partial class CrackRSA : Form
    {
        ...
        private void buttonCrack_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                using (var reader = new System.IO.StreamReader(@"C:\Users\Radmir.XTREME95\Desktop\RSACrack\RSA\bin\Debug\rsacrack.txt"))
                {
                    int i = 1;
                    string line;
                ...
                System.IO.File.WriteAllLines(@"C:\Users\Radmir.XTREME95\Desktop\RSACrack\RSA\bin\Debug\rsacrackready.txt", ress);
